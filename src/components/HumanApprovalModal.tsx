...
export const HumanApprovalModal: React.FC<HumanApprovalModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-fade-in">
      <div className="bg-[#18181B] border border-[#27272A] rounded-3xl max-w-2xl w-full p-6 shadow-2xl space-y-5 text-[#FAFAFA] relative max-h-[90vh] overflow-y-auto">
        {/* Safety Header */}
        ...
        <div className="p-4 rounded-2xl bg-[#09090B] border border-[#27272A] space-y-2">
          ...
          <p className="text-sm font-bold text-[#FAFAFA]">{actionItem.action}</p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 border-t border-[#27272A] pt-4">
          ...
          <div className="w-full sm:w-auto flex items-center gap-2">
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2 rounded-xl bg-[#09090B] hover:bg-[#27272A] text-xs font-semibold text-[#A1A1AA] hover:text-white transition-all cursor-pointer border border-[#27272A]"
            >
              {isDone ? 'Close' : 'Cancel'}
            </button>
